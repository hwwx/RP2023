...
static void CAN_Rx_Callback(CAN_HandleTypeDef *hcan)
{
		...
		HAL_CAN_GetRxMessage(&hcan1, CAN_RX_FIFO0, &hcan1RxFrame.header, hcan1RxFrame.data);
	  HAL_CAN_GetRxMessage(&hcan2, CAN_RX_FIFO0, &hcan2RxFrame.header, hcan2RxFrame.data);
		...
		/*2006波蛋论*/
		else if(hcan2RxFrame.header.StdId == 0x203)//2006
		{
